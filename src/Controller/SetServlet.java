...
public class SetServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(add!=null) {
			...
			request.setAttribute("bucketListadd",name /*pass the return value */);
		...
		if(remove!=null) {
			...
			request.setAttribute("bucketListremove",name /*pass the return value */);
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/set.jsp");
			rd.forward(request, response);
		}
		...
		if(sortbydestination!=null) {
			...
			request.setAttribute("bucketList",name /*pass the return value */);
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/set.jsp");
			rd.forward(request, response);
		}
