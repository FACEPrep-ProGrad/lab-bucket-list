...
public class SetServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(add!=null) {
			...
			request.setAttribute("bucketListadd", places);
		...
		if(remove!=null) {
			...
			request.setAttribute("bucketListremove", set.remove(touristobj));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/set.jsp");
			rd.forward(request, response);
		}
		...
		if(sortbydestination!=null) {
			...
			request.setAttribute("bucketList", set.sortByDestination(places));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/set.jsp");
			rd.forward(request, response);
		}
		...
		if(sortbyrank!=null) {
			...
			request.setAttribute("bucketList", set.sortByRank((HashSet<TouristPlace>) places));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/set.jsp");
			rd.forward(request, response);
		}
		...
		if(reset!=null) {
			...
			request.setAttribute("bucketList", set.reset((HashSet<TouristPlace>) places));
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/set.jsp");
			rd.forward(request, response);
		}
