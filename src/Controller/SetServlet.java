...
public class SetServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		TouristPlace obj = new TouristPlace(name,destination,rank);
		...
		if(remove!=null) {
			...
			request.setAttribute("bucketListremove", setobj);
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/set.jsp");
			rd.forward(request, response);
		}
		...
		if(sortbydestination!=null) {
			...
			setobj= set.sortByDestination(setobj);
			
			request.setAttribute("bucketList", setobj);
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/set.jsp");
			rd.forward(request, response);
		}
